...
```
2- Create a new deployment resource using the [ibmcom/guestbook](https://hub.docker.com/r/ibmcom/guestbook):v1 docker image in the project we just created.<br>
```
